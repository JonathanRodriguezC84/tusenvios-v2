...
<body class="min-h-screen bg-gray-50 text-gray-950">
    <header class="border-b border-gray-200 bg-white">
        <div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 sm:px-6">
            ...
            <a href="<?php echo e(route('login')); ?>" class="rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50">
                Ingresar
            </a>
        </div>
    </header>
    ...
    <main class="mx-auto max-w-5xl px-4 py-10 sm:px-6">
        <div class="te-hero-pattern rounded-2xl border border-gray-200 bg-white p-6 sm:p-10 shadow-sm">
            ...
            <form method="POST" action="<?php echo e(route('tracking.search')); ?>" class="mt-8">
                <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="mt-2 rounded-lg border border-red-200 bg-red-50 px-4 py-2 text-sm text-red-800"><?php echo e($message); ?></p>
                    <?php unset($message);
...
</html><?php /**PATH C:\Users\Rci Shop\Herd\tusenvios_local\resources\views/tracking/index.blade.php ENDPATH**/ ?>