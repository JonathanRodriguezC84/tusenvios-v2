    ...
    <body>
        <header class="site-header">
            <div class="container header-inner">
                <a href="/" class="logo" aria-label="Tus Envios">
                    <img src="<?php echo e(asset('images/logotusenvios.png')); ?>" alt="Tus Envios">
                </a>
        ...
        <main>
                ...
                <div class="container hero-grid">
                    <div>
                        ...
                        <div class="hero-actions">
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary">Probar 10 guias gratis</a>
                        ...
                        <div class="showcase-card">
                            ...
                            <div class="label-demo" aria-label="Etiqueta demo">
                                <div class="label-head">
                                    <div class="label-logo"><img src="<?php echo e(asset('images/logotusenvios.png')); ?>" alt="Logo demo"></div>
            ...
            <section class="cta-band">
                <div class="container cta-inner"><div><p class="eyebrow" style="color:rgba(255,255,255,.78)">Listo para probar</p><h2>Empieza hoy con tu primera etiqueta personalizada.</h2><p>Crea tus primeras 10 guias gratis. Luego activa tu plan mensual cuando quieras seguir creando.</p></div><a href="<?php echo e(route('register')); ?>" class="btn btn-orange">Crear cuenta gratis</a></div>
            </section>
        </main>
        <footer class="footer">
            <div class="container footer-inner">
                <div><img src="<?php echo e(asset('images/logotusenvios.png')); ?>" alt="Tus Envios"><div>Etiquetas y guias para emprendimientos</div></div>
                <div style="display:flex;flex-wrap:wrap;gap:16px"><a href="<?php echo e(route('tracking.index')); ?>">Rastrear guia</a><a href="<?php echo e(route('login')); ?>">Ingresar</a><a href="<?php echo e(route('register')); ?>" style="color:var(--brand-blue)">Crear cuenta</a></div>
            </div>
        </footer>
    </body>
</html>
<?php /**PATH C:\Users\Rci Shop\Herd\tusenvios_local\resources\views/welcome.blade.php ENDPATH**/ ?>