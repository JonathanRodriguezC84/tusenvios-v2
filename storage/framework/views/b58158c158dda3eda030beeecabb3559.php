...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="<?php echo e(route('brand-settings.edit')); ?>" class="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50">
                Diseño de guia
            </a>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="py-6">
        <div class="mx-auto w-full max-w-7xl px-4 sm:px-5 lg:px-6">
            <?php if(session('status')): ?>
                <div class="mb-4 rounded-md border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-semibold text-emerald-800"><?php echo e(session('status')); ?></div>
            <?php endif; ?>
            ...
            <?php endif; ?>
                        ...
                        <form method="POST" action="<?php echo e(route('store-settings.update')); ?>" enctype="multipart/form-data" class="configuration-form-grid">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PATCH'); ?>
                <input type="hidden" name="brand_color_fallback" value="<?php echo e($selectedBrandColor); ?>">
                ...
                <div class="configuration-column">
                    <section class="configuration-card rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                        ...
                        <div class="mt-4 grid gap-4">
                            <label class="grid gap-1 text-sm font-semibold text-gray-700">
                                Nombre de la tienda
                                <input name="name" value="<?php echo e(old('name', $brandOwner->name)); ?>" required class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                            </label>

                            <label class="grid gap-1 text-sm font-semibold text-gray-700">
                                Mensaje en etiqueta
                                <input name="brand_message" value="<?php echo e(old('brand_message', $brand['message'])); ?>" maxlength="120" placeholder="Gracias por tu compra" data-uppercase="false" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                            </label>
                            <div class="grid gap-4 sm:grid-cols-2 te-company-data-v25">
                                <label class="grid gap-1 text-sm font-semibold text-gray-700">
                                    Telefono de la tienda
                                    <input name="brand_phone" value="<?php echo e(old('brand_phone', data_get($brand, 'phone') ?? '')); ?>" placeholder="3001234567" inputmode="tel" data-uppercase="false" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                                </label>

                                <label class="grid gap-1 text-sm font-semibold text-gray-700">
                                    Barrio / sector
                                    <input name="brand_neighborhood" value="<?php echo e(old('brand_neighborhood', data_get($brand, 'neighborhood') ?? '')); ?>" placeholder="Chapinero" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                                </label>

                                <label class="grid gap-1 text-sm font-semibold text-gray-700 sm:col-span-2">
                                    Direccion de la tienda
                                    <input name="brand_address" value="<?php echo e(old('brand_address', data_get($brand, 'address') ?? '')); ?>" placeholder="Bodega principal - Calle 100 #15-20" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                                </label>

                                <label class="grid gap-1 text-sm font-semibold text-gray-700 sm:col-span-2">
                                    Ciudad / localidad
                                    <input name="brand_locality" value="<?php echo e(old('brand_locality', data_get($brand, 'locality') ?? '')); ?>" placeholder="Bogota" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                                </label>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="configuration-card rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                        ...
                        <div class="mt-4 grid gap-4 sm:grid-cols-2">
                            <label class="grid gap-1 text-sm font-semibold text-gray-700">
                                WhatsApp
                                <input name="brand_whatsapp" value="<?php echo e(old('brand_whatsapp', $brand['whatsapp'])); ?>" placeholder="3001234567" inputmode="tel" data-uppercase="false" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                            </label>

                            <label class="grid gap-1 text-sm font-semibold text-gray-700">
                                Instagram
                                <input name="brand_instagram" value="<?php echo e(old('brand_instagram', $brand['instagram'])); ?>" placeholder="@tumarca" data-uppercase="false" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                            </label>

                            <label class="grid gap-1 text-sm font-semibold text-gray-700">
                                Facebook
                                <input name="brand_facebook" value="<?php echo e(old('brand_facebook', $brand['facebook'] ?? '')); ?>" placeholder="tumarca" data-uppercase="false" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                            </label>

                            <label class="grid gap-1 text-sm font-semibold text-gray-700">
                                TikTok
                                <input name="brand_tiktok" value="<?php echo e(old('brand_tiktok', $brand['tiktok'] ?? '')); ?>" placeholder="@tumarca" data-uppercase="false" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                            </label>

                            <label class="grid gap-1 text-sm font-semibold text-gray-700 sm:col-span-2">
                                Sitio web
                                <input name="brand_website" value="<?php echo e(old('brand_website', $brand['website'])); ?>" placeholder="https://tumarca.com" data-uppercase="false" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
                            </label>
                        </div>
                    </section>

                    <?php if($brandOwner instanceof \App\Models\Tenant): ?>
                        <section class="configuration-card rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                            ...
                            <label class="mt-4 flex items-start gap-3 text-sm font-semibold text-gray-700">
                                <input type="checkbox" name="daily_tasks_enabled" value="1" class="settings-checkbox mt-0.5 rounded border-gray-300 text-blue-700 focus:ring-blue-700" <?php if(old('daily_tasks_enabled', $brandOwner->daily_tasks_enabled)): echo 'checked'; endif; ?>>
                                <span>
                                    Tareas Diarias
                ...
                <div class="configuration-column">
                    <section class="configuration-card configuration-logo-card rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                        ...
                        <div class="mt-4 flex gap-4 items-start">
                            ...
                            <div class="store-logo-preview flex-1 grid place-items-center rounded-lg border border-gray-200 bg-gray-50 p-4" style="min-height: 260px;">
                                <?php if($logoUrl): ?>
                                    <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($brandOwner->name); ?>">
                                <?php else: ?>
                    ...
                    <section class="configuration-card rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                        ...
                        <div class="brand-palette-grid mt-4">
                            <?php $__currentLoopData = $brandPalettes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $palette): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="brand-palette-option" style="--palette-color: <?php echo e($palette['color']); ?>">
                                    <input type="radio" name="brand_color" value="<?php echo e($palette['color']); ?>" class="sr-only" <?php if(strtolower($palette['color']) === $selectedBrandColor): echo 'checked'; endif; ?>>
                                    <span class="brand-palette-card">
                                        <span class="brand-palette-swatch"></span>
                                        <span class="text-xs font-black text-gray-700"><?php echo e($palette['name']); ?></span>
                                    </span>
                                </label>
                            ...
                            ?>
                            <label class="brand-palette-option" style="--palette-color: <?php echo e($customColor); ?>">
                                <input type="radio" name="brand_color" value="<?php echo e($customColor); ?>" class="sr-only" id="brand-color-custom-radio" <?php if($isCustom): echo 'checked'; endif; ?>>
                                <input type="color" id="brand-color-custom-picker" value="<?php echo e($customColor); ?>" class="sr-only">
                        ...
                        <div id="brand-color-preview" class="brand-palette-preview mt-4" style="--preview-color: <?php echo e($selectedBrandColor); ?>; --preview-text: #ffffff;">
...
<?php endif; ?>
<?php /**PATH C:\Users\Rci Shop\Herd\tusenvios_local\resources\views/brand-settings/configuration.blade.php ENDPATH**/ ?>