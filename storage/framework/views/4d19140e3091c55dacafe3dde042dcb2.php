    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="grid gap-4">
            <label class="grid gap-1 text-sm font-semibold text-gray-700">
                Correo
                <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="username" placeholder="correo@negocio.com" data-uppercase="false" class="rounded-md border-gray-300 text-base shadow-sm focus:border-blue-700 focus:ring-blue-700">
...
<?php endif; ?>
        ...
        <div class="mt-5 flex items-center justify-between gap-3">
            <?php if(Route::has('password.request')): ?>
                <a class="rounded-md text-sm font-semibold text-gray-600 underline hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2" href="<?php echo e(route('password.request')); ?>">
        ...
        <div class="mt-6 grid gap-2 border-t border-gray-200 pt-4">
            <a href="<?php echo e(route('register')); ?>" class="text-sm font-semibold text-blue-700 hover:underline">
                Crear cuenta para mi negocio
            </a>
            <a href="<?php echo e(url('/')); ?>" class="text-sm font-semibold text-gray-600 hover:underline">
                Volver a la portada
            </a>
        </div>
    </form>
...
<?php endif; ?>
<?php /**PATH C:\Users\Rci Shop\Herd\tusenvios_local\resources\views/auth/login.blade.php ENDPATH**/ ?>