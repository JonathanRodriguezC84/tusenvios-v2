...
Route::middleware(['auth', 'active.user'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/clients', [AdminClientController::class, 'clients'])->name('clients');
        Route::get('/clients/{tenant}', [AdminClientController::class, 'showClient'])->name('clients.show');
        Route::post('/clients/{tenant}/token', [AdminClientController::class, 'generateToken'])->name('clients.token');
        Route::post('/clients/{tenant}/webhook', [AdminClientController::class, 'updateWebhook'])->name('clients.webhook');
        Route::post('/clients/{tenant}/wallet', [AdminClientController::class, 'walletTransaction'])->name('clients.wallet');
        Route::get('/clients/create/new', [AdminClientController::class, 'createClient'])->name('clients.create');
        Route::post('/clients', [AdminClientController::class, 'storeClient'])->name('clients.store');
        Route::patch('/clients/{tenant}/status', [AdminClientController::class, 'updateClientStatus'])->name('clients.status');
        Route::get('/subscriptions', [AdminSubscriptionController::class, 'subscriptions'])->name('subscriptions');
        Route::patch('/subscriptions/{subscription}', [AdminSubscriptionController::class, 'updateSubscription'])->name('subscriptions.update');
        Route::post('/subscriptions/{subscription}/manual-payment', [AdminSubscriptionController::class, 'registerManualPayment'])->name('subscriptions.manual-payment');
        Route::post('/subscriptions/{subscription}/payment-link', [AdminSubscriptionController::class, 'createPaymentLink'])->name('payment-links.create');
        Route::post('/payments/{payment}/sync', [AdminSubscriptionController::class, 'syncPayment'])->name('payments.sync');
        Route::get('/plans', [AdminPlanController::class, 'plans'])->name('plans');
        Route::post('/plans', [AdminPlanController::class, 'storePlan'])->name('plans.store');
        Route::patch('/plans/{plan}', [AdminPlanController::class, 'updatePlan'])->name('plans.update');
        Route::delete('/plans/{plan}', [AdminPlanController::class, 'destroyPlan'])->name('plans.destroy');
        Route::get('/activity', [AdminSettingsController::class, 'activity'])->name('activity');
        Route::get('/activity/export', [AdminSettingsController::class, 'exportActivity'])->name('activity.export');
        Route::get('/users', [AdminUserController::class, 'users'])->name('users');
        Route::patch('/users/{user}/role', [AdminUserController::class, 'updateUserRole'])->name('users.role');
        Route::patch('/users/{user}/status', [AdminUserController::class, 'updateUserStatus'])->name('users.status');
        Route::get('/users/impersonate/{user}', [AdminUserController::class, 'impersonate'])->name('users.impersonate');
        Route::post('/subscriptions/bulk', [AdminSubscriptionController::class, 'bulkAction'])->name('subscriptions.bulk');
        Route::get('/settings', [AdminSettingsController::class, 'systemSettings'])->name('settings');
        Route::patch('/settings', [AdminSettingsController::class, 'updateSystemSettings'])->name('settings.update');
        Route::get('/carriers', [AdminSettingsController::class, 'carriers'])->name('carriers');
        Route::get('/api-docs', [AdminSettingsController::class, 'apiDocs'])->name('api-docs');
        ...
        Route::patch('/password', [AdminSettingsController::class, 'updatePassword'])->name('password');
    });
    ...
    Route::get('/inventory/movements', [InventoryMovementController::class, 'movements'])->name('inventory.movements');
    ...
    Route::get('/inventory/template', [InventoryImportController::class, 'template'])->name('inventory.template');
    Route::get('/inventory/movements/export', [InventoryMovementController::class, 'exportMovements'])->name('inventory.movements.export');
    Route::get('/inventory/movements/export/pdf', [InventoryMovementController::class, 'exportMovementsPdf'])->name('inventory.movements.export.pdf');
    ...
    Route::post('/inventory/{inventoryProduct}/movement', [InventoryMovementController::class, 'movement'])->name('inventory.movement');
    ...
    Route::match(['post', 'patch'], '/shipments/bulk-print', [ShipmentPrintController::class, 'bulkPrint'])->name('shipments.bulk-print');
    Route::patch('/shipments/bulk-status', [ShipmentStatusController::class, 'bulkUpdateStatus'])->name('shipments.bulk-status');
    Route::get('/shipments/{shipment}/print', [ShipmentPrintController::class, 'print'])->name('shipments.print');
    Route::get('/shipments/{shipment}/print/pdf', [ShipmentPrintController::class, 'printPdf'])->name('shipments.print.pdf');
    Route::patch('/shipments/{shipment}/status', [ShipmentStatusController::class, 'updateStatus'])->name('shipments.update-status');
    Route::patch('/shipments/{shipment}/cancel', [ShipmentStatusController::class, 'cancel'])->name('shipments.cancel');
