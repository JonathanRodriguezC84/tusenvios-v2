    ...
    <div class="py-6 sm:py-8">
        <div class="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <section class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                <form method="GET" action="{{ route('shipments.index') }}" class="grid gap-3 lg:grid-cols-[1fr_180px_170px_auto]">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('shipments.index') }}" class="rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-normal text-gray-700 shadow-sm hover:bg-gray-50">
                            Limpiar
                        </a>
                    </div>
                </form>
            ...
            <section class="mt-5 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
                ...
                <div class="shipment-simple-head border-b border-gray-200 bg-gray-50 px-5 py-3 text-xs font-semibold uppercase text-gray-500">
                ...
                <div class="divide-y divide-gray-200">
                    @forelse ($shipments as $shipment)
                        ...
                        <article class="shipment-simple-row">
                            <div>
                                ...
                                <p class="text-sm font-normal text-gray-700">{{ $shipment->created_at->format('d/m/Y H:i') }}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="truncate text-sm font-normal uppercase text-gray-700">{{ $citySummary }}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-sm font-normal text-gray-950">${{ number_format($shipment->collection_value, 0, ',', '.') }}</p>
                            </div>

                            <div class="shipment-simple-actions">
                                <a href="{{ route('shipments.print', $shipment) }}" target="_blank" class="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-normal text-gray-700 shadow-sm hover:bg-gray-50">
                                    Imprimir
                                </a>
                            </div>
                    ...
                    @empty
                        <div class="px-5 py-12 text-center">
                            <p class="text-lg font-semibold text-gray-950">No hay guias para mostrar.</p>
