...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'recipient_email' => 'correo del cliente',
        ...
        'recipient_notes' => 'observaciones',
        'sender_name' => 'nombre del remitente',
        'sender_phone' => 'teléfono del remitente',
        'sender_address' => 'dirección del remitente',
        'sender_neighborhood' => 'barrio del remitente',
        'sender_locality' => 'ciudad del remitente',
        ...
        'delivery_zone_id' => 'tarifa de envío',
    ],
